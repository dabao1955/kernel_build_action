...
# Configuration
readonly REPO_URL="https://github.com/dabao1955/kernel_build_action/raw/main/rekernel/patches"

# Define patches array
declare -ra PATCHES=(
    "signal.cocci:kernel/signal.c"
    "binder.cocci:drivers/android/binder.c"
    "binder_alloc.cocci:drivers/android/binder_alloc.c"
)
